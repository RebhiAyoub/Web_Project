...
include '/Applications/XAMPP/xamppfiles/htdocs/carvilla-v1.0/Model/question.php';
...
if (
    ...
    if (empty($errors['title']) && empty($errors['content']) && empty($errors['category'])) {
        ...
        header('Location: /carvilla-v1.0/View/user/model/Forum.php');
    }
}
    ...
    <section id="home" class="welcome-hero">
        ...
        <div class="container">
            <div class="welcome-hero-txt">
                <h2>"Empowering Women, Nurturing Health. Discover a journey to wellness with our comprehensive resources
                    and support. Welcome to a community that cares for every step of your health journey"</h2>
                            ...
                            <div id="container" class="bg-light p-4 rounded">
                                ...
                                <form action="" method="POST" id="form">
                                    ...
                                    <div class="form-group mt-3">
                                        <a href="/carvilla-v1.0/View/user/model/Forum.php" class="btn btn-outline-primary">Back
                                            to List</a>
                                    </div>
                                </form>
                            </div>
