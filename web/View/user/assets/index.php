...
<body>
							...
							<ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
								...
								<li class="scroll dropdown">
									...
									<ul class="dropdown-menu">
										<li><a href="/web/View/user/cycle7/view/index.php">Ovulation Date</a></li>
	...
	<section id="featured-cars" class="semah">
		<div class="container" style="padding-top:50px; height:800px;">
			<div>
				<a href="YourOrders.php"
					style="display: inline-block; padding-left: 10px;height:30px !important; width:100px;">
					<button class="button">
						<div class="inner"></div>
						<span>Orders</span>
					</button>
				</a>
				<h2 style="padding-left:450px;">Checkout our Products </h2>
			</div><!--/.section-header-->
								...
								<div class="testimonial-comment">
									...
									<div>
										...
										<button class="button-1"
											onclick="window.location.href='deleteFeedback.php'">
											<div class="inner"></div>
											<span>Delete</span>
										</button>
