...
// Get the last feedback from the database
$lastFeedback = $feedbackController->getLastFeedback();

// Check if $lastFeedback is not empty
if (!$lastFeedback) {
    // Handle the case where $lastFeedback is not found
    echo "Last feedback not found!";
    exit;
}

// Extract data from $lastFeedback
$feedbackId = $lastFeedback['idFeedback'];
$idUser = $lastFeedback['idUser'];
