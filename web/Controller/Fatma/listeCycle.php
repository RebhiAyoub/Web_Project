...
$c = new  CycleC();//same name as controller file 
$tab = $c->listcycles();//o as u like
...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assetsTable/img/find_user.png" class="user-image img-responsive"/>
                      ...
                      <li  >
                        <a  class="active-menu"  href="/cycle/view/cycle/listeCycle.php"><i class="fa fa-table fa-3x"></i>List Cycle</a>
                    </li>
                    <li  >
                        <a  href="/cycle/view/ovulation/listOvulations.php"><i class="fa fa-edit fa-3x"></i> List Ovulation </a>
                    </li>				
         ...
         <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Woman Cycle List</h2>   
                        <h2><a href="createCycle.php">Add Cycle</a></h2>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            echo '<tr><th>User ID </th><th>Current Period Date</th><th>Previous Period Date</th><th>Menstrual Cycle Length</th><th>Update</th><th>Delete</th></tr>';
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<td><form method="POST" action="editCycle.php"><span class="glyphicon glyphicon-pencil"></span><input type="submit" name="update" class="btn btn-default btn-sm" value="Update"><input type="hidden" value="' . $row["idUser"] . '" name="idUser"> </form></td>';
                                echo '<td><a class="btn btn-info btn-lg" href="deleteCycle.php?idUser=' . $row["idUser"] . '"><span class="glyphicon glyphicon-remove"></span>Delete</a> </td>';
                                echo '</tr>';
                            }
