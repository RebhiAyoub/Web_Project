...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $sql = "SELECT * FROM userTr WHERE idUser=$idUser";
    ...
    do{
        ...
        $sql =  "UPDATE userTr ". 
                "SET idUser = '$idUser' , period = '$period', length = '$length', Trimester = '$Trimester'".
                "WHERE idUser = $idUser";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="/web/View/admin/ui.php" role="button">Cancel</a>
                </div>
            </div>  
        </form>
