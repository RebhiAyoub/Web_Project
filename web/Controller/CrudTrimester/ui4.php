...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    do {
        ...
        //retrieve idTrimester
        $idTrimesterSql = "SELECT idUser AS idTrimester FROM userTr";
        $idTrimesterResult = $conn->query($idTrimesterSql);
        $idTrimesterRow = $idTrimesterResult->fetch_assoc();
        $idTrimester = $idTrimesterRow['idTrimester'];



        // Add the new delivery date to the database
        $sql = "INSERT INTO user(idUser, period, length, deliveryDate,trimesterr)
                VALUES ('$idUser', '$period', '$length', '$deliveryDate','$idTrimester')";
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="/web/Controller/back/ui.php" role="button">Cancel</a>
                </div>
            </div>  
        </form>
