...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        do {
            ...
            // Add the new trimester to the database using prepared statements
            $stmt = $conn->prepare("INSERT INTO userTr(idUser, period, length, Trimester) VALUES (?, ?, ?, ?)");
            $stmt->execute([$idUser, $period, $length, $Trimester]);
