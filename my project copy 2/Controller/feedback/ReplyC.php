...
require_once 'C:\xampp\htdocs\FEEDBACK\model\Reply.php';
require_once 'C:\xampp\htdocs\FEEDBACK\config.php'; // Assuming config.php contains the database connection logic
