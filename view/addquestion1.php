                        ...
                        <div id="container" class="bg-light p-4 rounded">
                            ...
                            <form action="" method="POST" id="form">
                                <div class="form-group">
                                    ...
                                    <p class="text-danger" id="titleError"><?php echo $errors['title']; ?></p>
                                </div>

                                <div class="form-group">
                                    <label for="content">Content:</label>
                                    <input type="text" id="content" name="content" class="form-control" required />
                                    <p class="text-danger" id="contentError"><?php echo $errors['content']; ?></p>
                                </div>
            ...
            setTimeout(function () {
                popupContainer.style.display = "none";
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-danger" id="categoryError"><?php echo $errors['category']; ?></p>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    <a href="listquestion1.php#featured-cars" class="btn btn-outline-primary">Back to List</a>
                                </div>
                            </form>
                        </div>
                    </div>
