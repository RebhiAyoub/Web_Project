...
if (		
    ...
    {   
        ...
        header("Location:indexBack.php?successMessage= Product added successfully");
    ...
    <br>
        ...
        <form method="post" class="form" name="form"  id="form" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class=" input-group mb-3 ">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control"  name="Product_name" id="Product_name"  placeholder= "Product_name">
                </div>
            </div>
            ...
            <!---------------------------------------------prix---------------------------------------------->
                <div class="input-group mb-3">
                    <label class="col-sm-3 col-form-label ">Product_price</label>
                      <div class="col-sm-6">
                    <input type="text" class="form-control" name="Product_price" id="Product_price"  placeholder ="Product_price"  >
                </div>
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="Availabilityy" id="Availabilityy" placeholder= "Availability"  >
                </div>
             </div>
             <!---------------------------------------------img---------------------------------------------->
            <div class="input-group mb-3">
