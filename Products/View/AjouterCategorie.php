...
if (		
    ...
    {   
        ...
        header("Location:indexCategory.php?successMessage= Categorie ajoutée avec successee");
    }
    else
...
<head>
 ...
 <div class="row mb-5">
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherCategorie.php" role="button">Cancel</a>
             </div>
          </div>
