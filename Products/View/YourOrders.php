			...
			<div class="container">
             ...
             ?>
              ...
              <td><?php echo $produit['Product_name']; ?></td>
							<td> <input  class="int-num" type="number" min="1" name="quantite"  id="quantite" value="<?php echo $commande['quantite']; ?>">  
							<?php
							...
							<td><input class="add-to-cart-btn" type="submit" value="Update" name="updateCommande" id="updateCommande"  >
						     <a  class="add-to-cart-btn" href="SupprimerCommande.php?idCommande=<?php echo $commande['idCommande']; ?>">Cancel</a>
